...
ROOT=distill_runs/dmd_ladd_u05_multideep_adv_weight_from_g300_joint22500_20260716
...
exec 9<"$ROOT"
if ! flock -n 9; then
  echo "multi-deep adversarial-weight training is already running" >&2
  exit 75
fi
...
# Zero is a DMD/paired/FSQ ablation. The other arms form a log-spaced bridge
# back to the current 1e-3 LADD coupling. Everything else is held fixed.
run_arm adv0 0 29741
run_arm adv1e4 1e-4 29742
run_arm adv3e4 3e-4 29743
run_arm adv1e3 1e-3 29744
