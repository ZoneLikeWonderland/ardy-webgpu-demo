...
SOURCE=distill_runs/text_control_joint_fullproj_resume5000_4gpu_b256_const1e5_until_plateau_step20000_ema995_20260715
STATE="$SOURCE/state/step-0020000"
OUTPUT=distill_runs/text_control_joint_fullproj_resume20000_4gpu_b256_const5e6_until_plateau_step40000_ema995_20260715
...
exec accelerate launch \
  ...
  --learning-rate 5e-6 \
  --condition-learning-rate 5e-6 \
  --lr-schedule constant \
  --lr-decay-step 1000000 \
  --final-learning-rate 5e-6 \
  --final-condition-learning-rate 5e-6 \
